...
namespace SUS.MvcFramework
{
    ...
    {
        private const string USER_ID_SESSION_NAME = "UserId";
        ...
        {
            this.Request.Session[USER_ID_SESSION_NAME] = userId;
        }

        protected void SignOut()
        {
            this.Request.Session[USER_ID_SESSION_NAME] = null;
        }

        protected bool IsUserSignedIn() =>
            this.Request.Session.ContainsKey(USER_ID_SESSION_NAME) &&
            this.Request.Session[USER_ID_SESSION_NAME] != null;
